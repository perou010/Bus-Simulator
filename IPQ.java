public interface IPQ {
    ...
    //Places an event object into priority queue with priority given by time
    ...
    //Returns the priority associated with the top priority event in the priority queue
