...
How To Use
==========
1. Open BusSim.java, edit line 114 (first line of main function) to desired load value and save. 
  
2. Compile BusSim.java.

3. Run BusSim.

4. Printed output reveals the ideal value for number of buses (1 - 18) and whether all small buses (0), all large buses (2), or a 50/50 split (1) is best.
